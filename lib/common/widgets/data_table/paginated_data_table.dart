...
class PPaginatedDataTable extends StatelessWidget {
  const PPaginatedDataTable({
    super.key,
    ...
    this.dataRowHeight = PSizes.xl * 2,
        ...
        child: PaginatedDataTable2(
          ...
          sortArrowBuilder: (bool ascending, bool sorted) {
            if (sorted) {
              ...
              return const Icon(Iconsax.arrow_3, size: PSizes.iconSm);
            }
          },
        ),
      ),
