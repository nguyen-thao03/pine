...
class ProductAttributes extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Obx(() {
          return editController.productType.value == ProductType.single
          ? const Column(
            children: [
        ...
        Obx(
          () => editController.productType.value == ProductType.variable && variationController.productVariations.isEmpty
            ? Center(
            child: SizedBox(
              width: 200,
